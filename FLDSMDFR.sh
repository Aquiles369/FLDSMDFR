...
python3 /home/$usuario/FLDSMDFR/TOOLS_Y_INSTALADOR/CMSeeK/cmseek.py   -u $target > $results_dir/CMS/cms.txt  2>/dev/null
...
echo "https://web-check.xyz/results/https%3A%2F%2F$target" > $results_dir/WHOIS/web.txt 2>/dev/null
...
subdomains=$ sublist3r -d $target  >  $results_dir/Domain_reconnaissance/subdomains_sublister.txt
...
ffuf -w /home/$usuario/FLDSMDFR/TOOLS_Y_INSTALADOR/SecLists/Discovery/Web-Content/directory-list-2.3-small.txt -c -v -rate 1 -recursion-depth 10 -t 10 -u http://$target/FUZZ > $results_dir/FFUF/subdomain.txt 2>/dev/null  &
#echo "------------------------------------------------------------------"
