...
- dnsrecon :("CONVIERTE TODAS LOS SUBDOMAIN VIVO A IP " Y ADEMAS SACA LOS )<br> 
- google_dorks :("GOOGLE_DORKS MUY INTERESANTES DE VARIOS ROBOT.TXT Y MUCHO MAS INGRESAR A CADA LINKS")<br> 
- escaner_de_encabezados :("HACE UNA BUSQUEDA EN LAS CABEZERAS EN BUSCA DE ALGUNA MALA CONFIGURACION  TE IMPRIME QUE CABEZERA ESTAN PRESENTE Y CUALES NO")<br> 
...
- ffuf :("APROVECHA Y FUZZEA SACANDO LSO SUBDOMAIN DEL TARGET PODES CONCATENAR EL RESULTADO CON EL ARCHIVOS SUBDOMAIN VIVOS": ADEMAS TE SACA LOS DIRECTORIOS DEL TARGET)<br> 
...
- bigbountyRecon :("SE EJECUTA LA  APLICACION  .EXE ENCESITAS INTALAR PREVIAMENTE WINE:I386 PARA SU CORRECTO FUNCIONAMIENTO : INGRESAS EL TARGET Y TENES MAS DE 58 TOOLS PARA DORKIN DEL")"POR MOTIVOS PARA QUE NO SE HAGA MAS EXTENSO DE LO QUE YA ES TE DEJO EL LINKS PARA VER QUE TOOLS ESTAN EN ESTA HERRAMIENTA EN PALABRAS SIMPLES HACE UN DORKING DE VARIOS SITIOS WEB ETC LA AGRERO A ESTA TOOLS POR QUE VALE LA PENA TENER EN TU ARSENAL: bigbountyRecon https://github.com/Viralmaniar/BigBountyRecon "<br>
<br>
