...
- google_dorks :("GOOGLE_DORKS MUY INTERESANTES DE VARIOS ROBOT.TXT Y MUCHO MAS INGRESAR A CADA LINKS")<br> Ç
- curl: ("EXTRAE TODO EL CODIGO DEL FRONT DEL TARGET")
- exilftool: ("DEFAUL , TENES QUE SACAR # , Y PONER LÑA RUTA DE LA IMAGEN A ANALIZAR")
...
- holehe: ("DEFAUL , PODER ACTIVAR TENES QUE SACAR LAS # , PODES COMPROBAR EN QUE SITIO WEB FUE CREADA CUENTA  CON ESE CORREO.")
...
- nmap :("SE UTILIZA UN SCRYPT PARA BUSCAR VULNERABILIDADES EN EL ARCHIVO SUBDOMAIN VIVOS limpios Y DEL TARGET TAMBIEN  , TE SACA LA  VERSION Y MUCHO")<br> 
