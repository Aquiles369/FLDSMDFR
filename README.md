...
+[install.sh:](DOCUEMENTACION_COMPLETA/installl.sh)<br>
...
- wafw00f :("UTILIZA LA TOOLS PARA SACAR EL WAFF DEL TARGET")<br>ç
...
- linkedin :("INGRESAR CON TU CUENTA O CUENTA FALTA , BUSCA LA EMPRESA EN LINKEDIN , LUEGO QUE ENCONTRAS LA EMPRESA BUSCA A LOS DESARROLLADORES Y EXTRAE SU NOMBRE CON SU NOMBRE YA BUSCAR EN GIT HUB TOKEN , KEY , LINKIDADOS SUBDOMAIN ETC. POSIBLEMENTE ENCUENTRES ALGO.")
<br>
