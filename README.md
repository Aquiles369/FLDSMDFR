...
- shodan :("SHODAN HACE UNA CONSULTA DEL TARGET"CONFIGURAR API YE TE MUESTRA EL LINKS INGRESAR )<br> 
...
- nmap :("SE UTILIZA UN SCRYPT PARA BUSCAR VULNERABILIDADES EN EL ARCHIVO SUBDOMAIN VIVOS limpios , TE SACA LA  VERSION Y MUCHO")<br> 
